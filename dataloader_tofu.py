...
import copy, os
# import deepspeed  # Commented out DeepSpeed import
from evaluate_util_tofu import get_dataloader, get_all_evals
import copy
import json 
from pathlib import Path
from data_module_tofu_DP import get_batch_loss 
from utils_tofu import merge_dicts, interleave_eval_result_dict, get_forget_quality, get_model_utility
import numpy as np
from scipy.stats import ks_2samp, hmean
import csv 
# from transformers.integrations.deepspeed import deepspeed_init, deepspeed_load_checkpoint, is_deepspeed_available  # Commented out DeepSpeed imports
...
class CustomTrainerForgetting(Trainer):
    ...
    def e_prepare_deepspeed(self, model):
        ...
        # deepspeed_plugin = self.accelerator.state.deepspeed_plugin  # Commented out DeepSpeed code
        config_kwargs = copy.deepcopy(self.accelerator.state.deepspeed_plugin.deepspeed_config)  # Modified to avoid undefined reference
        ...
        # model, *_ = deepspeed.initialize(model=model, config=config_kwargs)  # Commented out DeepSpeed initialization
        model.eval()
    ...
    def evaluate(
        ...
        # if self.is_deepspeed_enabled and self.deepspeed is None:  # Commented out DeepSpeed condition
        #     _, _ = deepspeed_init(self, num_training_steps=0, inference=True)  # Commented out DeepSpeed initialization
        args = self.args
        ...
        if len(self.accelerator._models) == 0 and model is self.model:
            ...
            # if self.is_deepspeed_enabled:  # Commented out DeepSpeed code
