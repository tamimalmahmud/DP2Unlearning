from data_module_tofu_DP import TextForgetDatasetQA, TextForgetDatasetDPOQA
from dataloader_tofu import CustomTrainerForgetting, custom_data_collator_forget
import torch
...
@hydra.main(version_base=None, config_path="config", config_name="forget_tofu.yaml")
def main(cfg):
